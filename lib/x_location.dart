...
class AMapFlutterLocation {
  ...
  ///后台定位
  void backGroundRun() {
    _methodChannel.invokeMethod('backGroundRun', {'pluginKey': _pluginKey});
    return;
  }

  ///前台定位
  void unBackGroundRun() {
    _methodChannel.invokeMethod('unBackGroundRun', {'pluginKey': _pluginKey});
    return;
  }
