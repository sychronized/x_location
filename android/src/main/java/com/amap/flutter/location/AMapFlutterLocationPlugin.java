  ...
  public void onMethodCall(MethodCall call, Result result) {
    ...
    switch (call.method) {
      ...
      case "stopLocation":
        ...
        break;
      case "backGroundRun":
        backGroundRun((Map) call.arguments);
        break;
      case "unBackGroundRun":
        unBackGroundRun((Map) call.arguments);
        break;
      case "destroy":
...
//            e.printStackTrace();
   ...
   * 后台定位
   */
  private void backGroundRun(Map argsMap) {
    AMapLocationClientImpl locationClientImp = getLocationClientImp(argsMap);
    if (null != locationClientImp) {
      locationClientImp.backGroundRun();
    }
  }
   ...
   * 前台定位
   */
  private void unBackGroundRun(Map argsMap) {
    AMapLocationClientImpl locationClientImp = getLocationClientImp(argsMap);
    if (null != locationClientImp) {
      locationClientImp.unBackGroundRun();
    }
  }
